...
// import { FaGamepad, FaPlane, FaJsSquare, FaNodeJs, FaReact, FaGitAlt, FaJava, FaPython } from 'react-icons/fa';
// import { TbBrandCpp } from 'react-icons/tb';
// import { SiMongodb, SiPostgresql, SiNextdotjs, SiVercel } from 'react-icons/si';
...
//           <p>
//             Hi Everyone, I am Chetan Parate from Chandrapur.
//           </p>
//           <p>
//             I am a final year student pursuing Computer Engineering at Rajiv Gandhi college of Engineering, research and texhnology.
//           </p>
//           <p>
...
//         {/* Right Image Section */}
//         <div className="w-md  flex justify-center mt-8 ">
//           <img src={image1} alt="Image" className="w-3/4 rounded-xl md:w-full" />
//         </div>
//       </div>
...
const About = () => {
  ...
  return (
    <section id="about" className="w-full min-h-screen text-white flex flex-col items-center justify-center px-4 py-28 space-y-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl w-full">
        ...
        <div className="md:w-1/2 space-y-4 text-lg">
          ...
          <p>
            I am a final year student pursuing Computer Engineering at Rajiv Gandhi College of Engineering, Research and Technology.
          </p>
        ...
        {/* Right Image Section */}
        <div className="w-md flex justify-center mt-8">
          <img src={image1} alt="Chetan" className="w-3/4 rounded-xl md:w-full" />
        </div>
      </div>
